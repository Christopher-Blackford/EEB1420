...
population_loop[1,1] <- 39*5
population_loop[1,2] <- 724*5
population_loop[1,3] <- 645*5
...
########################################################################
#[8] Plotting time to extinction across model simulations
base_title <- paste0("r_mean=", r_mean[Multiple_r_scenarios], " r_sd=", r_sd, " K=", K_base[Multiple_K_scenarios], " Num_sims=", number_of_simulations)
base_title
